...
public class ManagerStaffDetailServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            StaffViewModel staff = staffDAO.getStaffById(id);
            if (staff == null) {
            ...
            int workedShifts = staffShiftDAO.countWorkedShiftsInRange(UUID.fromString(staff.getUserId()), firstDay, lastDay);
            staff.setWorkedShiftsThisMonth(workedShifts);

            request.setAttribute("staff", staff);
            request.setAttribute("monthLabel", now.getMonthValue() + "/" + now.getYear());
