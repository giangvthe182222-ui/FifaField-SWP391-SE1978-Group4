...
public class LocationEquipmentDAO {
    ...
    public List<LocationEquipmentViewModel> getFiltered(UUID locationId, String search, String type, String status, String sort, int page, int pageSize) {
        List<LocationEquipmentViewModel> list = new ArrayList<>();
    ...
    public int countFiltered(UUID locationId, String search, String type, String status) {
    ...
    public boolean updateStatusAndQuantity(UUID locationId, UUID equipmentId, String status, int quantity) {
    ...
    public LocationEquipmentViewModel getOne(UUID locationId, UUID equipmentId) {
