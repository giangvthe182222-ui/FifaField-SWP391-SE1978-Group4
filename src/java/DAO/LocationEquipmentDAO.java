...
public class LocationEquipmentDAO {
    ...
    public List<LocationEquipmentViewModel> getByLocation(UUID locationId) {
        ...
        String sql = "SELECT e.equipment_id,e.name,e.equipment_type,e.image_url,le.quantity,e.rental_price,e.damage_fee,le.status FROM Location_Equipment le JOIN Equipment e ON e.equipment_id = le.equipment_id WHERE le.location_id = ? ORDER BY e.name";
    ...
    public List<LocationEquipmentViewModel> getFiltered(
        ...
        StringBuilder sql = new StringBuilder("SELECT e.equipment_id, e.name, e.equipment_type, e.image_url, le.quantity, e.rental_price, e.damage_fee, le.status FROM Location_Equipment le JOIN Equipment e ON e.equipment_id = le.equipment_id WHERE le.location_id = ?");
    ...
    public LocationEquipmentViewModel getOne(
        ...
        String sql = "SELECT e.equipment_id,e.name,e.equipment_type,e.image_url,le.quantity,e.rental_price, e.damage_fee, le.status FROM Location_Equipment le JOIN Equipment e ON e.equipment_id = le.equipment_id WHERE le.location_id = ? AND le.equipment_id = ?";
