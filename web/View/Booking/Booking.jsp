...
<main class="flex-grow max-w-7xl mx-auto px-6 py-12 space-y-10 w-full">
    ...
    <div class="flex flex-col space-y-8">
        <div class="space-y-2">
            <a href="${pageContext.request.contextPath}${dashboardPath}" class="w-10 h-10 bg-white rounded-xl border border-gray-100 text-gray-400 hover:text-[#008751] hover:border-[#008751] transition-all flex items-center justify-center" aria-label="Quay lại" title="Quay lại dashboard">
