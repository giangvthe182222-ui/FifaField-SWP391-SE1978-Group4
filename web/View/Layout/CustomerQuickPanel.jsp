...
<div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 gap-4">
    ...
    <a href="${pageContext.request.contextPath}/customer/my-calendar" class="group rounded-3xl border-2 border-gray-50 bg-gray-50/50 p-6 hover:border-[#008751] hover:bg-white transition-all">
        <div class="w-10 h-10 bg-white rounded-xl flex items-center justify-center text-gray-400 group-hover:text-[#008751] shadow-sm mb-4 transition-colors">
            <i data-lucide="calendar-search" class="w-5 h-5"></i>
        </div>
        <p class="text-[9px] font-black uppercase text-gray-400 tracking-widest">Lịch cá nhân</p>
        <p class="text-lg font-black text-gray-900 mt-1 uppercase tracking-tighter">Lịch chơi của tôi</p>
    </a>
</div>
